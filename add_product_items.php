  ...
  <div class="container">
    ...
    <div class="col-xs-3" style="text-align: center;">
      ...
      <div class="list-group">
        ...
        <a href="add_product_items.php" class="list-group-item active">Add Product Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="add_product_items1.php" method="POST">
          <br style="clear: both">
          ...
          <div class="form-group">
            <input type="number" class="form-control" id="price" name="price" placeholder="Your Product Price (RM)" required="">
          </div>
          ...
          <div class="form-group">
            ...
            <select name="product_type" class="form-control" id="exampleFormControlSelect1" required="">
          ...
          <div class="form-group">
            ...
            <select name="product_brand" class="form-control" id="exampleFormControlSelect1" required="">
              ...
              <option value="scitec_nutrition">Scitec Nutrition</option>
