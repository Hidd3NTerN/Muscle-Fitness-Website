...
<head>
  <title> Admin Signup | Muscle Fitness </title>
</head>
...
<body>
  ...
  <div class="container">
    <div class="jumbotron">
      <h1>Hi Admin, <br> Welcome to <span class="edit"> Muscle Fitness </span></h1>
      <br>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <form role="form" action="manager_registered_success.php" method="POST">
            ...
            <div class="row">
              <div class="form-group col-xs-12">
                <label for="security_key"><span class="text-danger" style="margin-right: 5px;">*</span> Security_key: </label>
                <div class="input-group">
                  <input class="form-control" id="security_key" type="password" name="security_key" placeholder="MFxxxx" required="">
                  <span class="input-group-btn">
                    <label class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></label>
                  </span>
                </div>
                <small>Contact admin for secuity key</small>
              </div>
            </div>
