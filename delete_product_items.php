...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/delete_product_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_product_items.php" class="list-group-item active">Delete Product Items</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_product_items1.php" method="POST">
        <br style="clear: both">
...
$sql = "SELECT * FROM product f WHERE f.R_ID IN (SELECT r.R_ID FROM gyms r WHERE r.M_ID='$user_check') ORDER BY F_ID";
