...
<h2 class="text-center"> Thank you for shopping at Muscle Fitness! The ordering process is now complete.</h2>
 ...
 <div class="container" >
  ...
  <div class="box">
    <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
      ...
      <a href="productlist.php" class="btn btn-primary">Continue Shopping</a>
    </div>
  </div>
