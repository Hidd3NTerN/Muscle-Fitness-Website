...
<head>
  <title> Cart | Muscle Fitness </title>
</head>
...
<body>
      ...
      <div class="collapse navbar-collapse " id="myNavbar">
        ...
        ?>
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="productlist.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart
                (<?php
                  if (isset($_SESSION["cart"])) {
                    $count = count($_SESSION["cart"]);
                    echo "$count";
  ...
  ?>
    <div class="container">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
        <p>Oops! The cart is empty. Go back and <a href="productlist.php">order now.</a></p>
