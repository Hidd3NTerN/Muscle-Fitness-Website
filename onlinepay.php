...
<head>
  <title> Online Payment | Muscle Fitness </title>
</head>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <input type="text" maxlength="4" minlength="4" class="form-control" placeholder="0000" required="true" />
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <input type="text" maxlength="4" minlength="4" class="form-control" placeholder="0000" required />
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <input type="text" maxlength="4" minlength="4" class="form-control" placeholder="0000" required />
                  </div>
                ...
                <div class="row ">
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    ...
                    <input type="text" maxlength="2" minlength="2" class="form-control" placeholder="MM" required="" />
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <span class="help-block text-muted small-font"> Expiry Year</span>
                    <input type="text" maxlength="2" minlength="2" class="form-control" placeholder="YY" required="" />
                  </div>
                  <div class="col-md-3 col-sm-3 col-xs-3">
                    <span class="help-block text-muted small-font"> CCV</span>
                    <input type="text" maxlength="3" minlength="3" class="form-control" placeholder="CCV" required="" />
                  </div>
                ...
                <div class="row ">
                  <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                    <a href="payment.php"><button type="button" class="btn btn-danger btn-block">CANCEL</button>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
