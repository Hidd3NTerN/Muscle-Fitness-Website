<html>
  ...
  <head>
    <title> Guest Signup | Muscle Fitness </title>
  </head>
  ...
  <!--Javacript for back to top button....................................................................-->
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Muscle Fitness </span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4-5}" name="contact" placeholder="Contact" required="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span></label>
              </div>           
              <small>Eg: 011-199-50594</small>
          </div>
        </div>
