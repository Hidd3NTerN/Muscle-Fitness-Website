...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="css/edit_product_items.css">
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="edit_product_items.php" class="list-group-item active">Edit Product Items</a>
    		<a href="delete_product_items.php" class="list-group-item ">Delete Product Items</a>
        <a href="view_order_details.php" class="list-group-item ">View Order Details</a>
        <a href="analytics.php" class="list-group-item">Analytics</a>
    	</div>
    </div>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "SELECT * FROM product f WHERE f.R_ID IN (SELECT r.R_ID FROM gyms r WHERE r.M_ID='$user_check') ORDER BY name");
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='edit_product_items.php?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM product WHERE F_ID=$update");
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="edit_product_items.php" method="GET">
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Product Price (RM)" required="">
          </div>
